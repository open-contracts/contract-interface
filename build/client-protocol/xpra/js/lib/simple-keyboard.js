...
var getDefaultLayout = function getDefaultLayout() {
  return {
    default: ["q w e r t y u i o p {bksp}", "a s d f g h j k l {enter}", "{shift} z x c v b n m , . !", "{minify} {space} {digits}"],
    shift: ["Q W E R T Y U I O P {bksp}",  "A S D F G H J K L {enter}", "{shift} Z X C V B N M , . !", "{minify} {space} {digits}"],
    digits: ["1 2 3 4 5 6 7 8 9 0 {bksp}", '~ ! @ # $ % ^ * " {enter}', "[ ] \\ / < > ?  ( ) _ + : &", "{minify} {space} {letters}"],
    minify: ["{expand}"]

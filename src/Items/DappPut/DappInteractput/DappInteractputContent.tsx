                    ...
                    <div style={{
                        ...
                        <div style={{
                            ...
                            <div style={{
                                ...
                                &ensp;
                                <LogoB logoColor={Colors.lilac} size={"50px"} label={false}/>&ensp;
                                <div>
                                <h3 style={{
                                    color : Colors.lilac
                                ...
                                }}>Contract: </span><a href={openContract && openContract.explorerUrl(openContract.contract.address)}>{openContract && openContract.contract.address}</a>
                                </div>
                            </div>
                            <div 
                            style={{
